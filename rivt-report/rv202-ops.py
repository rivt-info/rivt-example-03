...
rv.R(r"""OpenSees Shell
    ...
    the system. This section runs a shell command in a virtual Python environment for
    Python-3.12 - the version compatible with OpenSeesPy.
    ...
    | COPY | scripts | %userprofile%/py312/ | opsmod1.py

    Run shell command _[B]

    | SHELL | scripts | ops1.cmd

    Copy images and text from OpenSees analysis _[B]

    | COPY | %userprofile%/py312/ | -rvsrc-/image | *.png
