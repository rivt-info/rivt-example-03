...
rv.R(r"""OpenSees ops-mod1 Model
...
rv.I(r"""ops-mod1 Input

    **Model Input**

    | TEXT | rvsrc/scripts/opsmod1.py | python

    """)

rv.I(r"""Model plots and output | pdfpage
