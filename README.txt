...
================================================================================
| rivt report | Tree Fort v-1.0.0a17 | R Holland | 2026-07-27
================================================================================
...
--------------------------------------------------------------------------------
| rivt | Loads | R Holland | v-1.0.0a13 | 2026-07-27 - 01:45PM
--------------------------------------------------------------------------------
...
-  OpenSees https://opensees.berkeley.edu for determing the period of the tree fort system.
          ...
          ----------------------------------------
Fig. 1.1 - Report Flow Chart [file: outputb.jpg  ]
          ----------------------------------------
...
--------------------------------------------------------------------------------
| rivt | OpenSees Analysis | R Holland | v-1.0.0a13 | 2026-07-27 - 01:45PM
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
The model is run in a virtual environment with Python 3.12 and OpenSeesPyinstalled. The model calculates the natural frequencies and mode shapes ofthe system. This section runs a shell command in a virtual Python environment forPython-3.12 - the version compatible with OpenSeesPy.File written to: /_rvstore/data/ops1.cmd
...
Copy images and text from OpenSees analysis _[B]Copied *.png from .../rivt-report/rvsrc/scripts to .../-rvsrc-
...
--------------------------------------------------------------------------------
| rivt | RISA Analysis | R Holland | v-1.0.0a13 | 2026-07-27 - 01:45PM
--------------------------------------------------------------------------------
...
================================================================================
          ...
          ----------------------------------------
Fig. 1.1 - Risa Model [file: risa4.png  ]
          ----------------------------------------

 
          ----------------------------------------
Fig. 1.2 - Rail Lateral Forces [file: risa9.png  ]
          ----------------------------------------
...
--------------------------------------------------------------------------------
          ...
          ----------------------------------------
Fig. 2.1 - Strut Axial Forces [file: risa6.png  ]
          ----------------------------------------
...
--------------------------------------------------------------------------------
| rivt | Component Design | R Holland | v-1.0.0a13 | 2026-07-27 - 01:45PM
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
| rivt | Connection Design | R Holland | v-1.0.0a13 | 2026-07-27 - 01:45PM
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
| rivt | Member Design | R Holland | v-1.0.0a13 | 2026-07-27 - 01:45PM
--------------------------------------------------------------------------------
